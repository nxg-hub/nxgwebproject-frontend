...
const About = () => {
  return (
    <main className="center w-screen overflow-x-hidden">
      ...
      <div className="order-last md:order-first md:w-[60%] flex-col gap-10 items-start flex mb-[3rem] md:mb-0">
      <h3 className="lg:text-[32px] md:text-[20px] font-semibold text-secondary">
      We bring you Creativity at its best!
      </h3>
        <p className="lg:text-[18px] md:text-[16px]">
  ...
  <div className="order-first md:order-last md:w-[35%]">
    <img src={AboutOne} alt="About" className="mb-8"/>
  </div>
</div>
</div>
  ...
  <div className="md:w-[35%] float-left">
    <img src={AboutTwo} alt="About" className="mb-8" />
  </div>
  <div className="md:w-[60%] flex-col gap-10 items-start flex md:ml-[20px]">
    <h3 className="lg:text-[32px] md:text-[20px] font-semibold text-secondary">
      Our Mission
    </h3>
    <p>
...
<div className="mb-20"></div>
  ...
  <div className="order-first md:order-last md:w-[35%]">
    <img src={AboutThree} alt="About" className="mb-8" />
  </div>
</div>
