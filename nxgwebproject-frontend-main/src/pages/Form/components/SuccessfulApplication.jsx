          ...
          <div className="w-f[90%] m-auto">
            ...
            <div className="w-[90%] m-auto pb-5 md:text-md">
              <p>
                ...
                board. Our team is currently reviewing all registrations and
                will reach out to you soon with further details. We appreciate
                your patience during this process. If you have any questions in
